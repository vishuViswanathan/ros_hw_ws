...
def generate_launch_description():
    ...
    second_model_path = urdf_tutorial_path / 'urdf/fl_robot02.xacro'
    ...
    model_arg2 = DeclareLaunchArgument(name='model', default_value=str(second_model_path),
                                      description='Absolute path to robot urdf file')
    ...
    second_robot_name_in_model = 'mv_robot2'
    ...
    spawn_entity_cmd = Node(
      ...
      arguments=['-entity', robot_name_in_model, 
                  '-topic', 'robot_description',
                      ...
                      '-Y', spawn_yaw_val],
                      output='screen')
    # Launch the 2nd robot
    spawn_entity_cmd2 = Node(
      package='gazebo_ros', 
      executable='spawn_entity.py',
      arguments=['-entity', second_robot_name_in_model, 
                  '-topic', 'robot_description',
                      '-x', spawn_x_val,
                      '-y', '0.0',
                      '-z', spawn_z_val,
